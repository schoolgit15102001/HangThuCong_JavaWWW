              ...
              <div class="col-md-8 col-md-push-2">
                <div class="aa-myaccount-register">                 
                 ...
                 <form name="formRegister" class="aa-login-form" method="post" action="${pageContext.request.contextPath}/view/client/register" >
                    ...
                    <input type="text" placeholder="useremail@gmail.com" name="email" pattern="^(.+)@gmail.com$" required>
                    <label for="">Số điện thoại<span>*</span></label>
                    <input type="text" placeholder="Số điện thoại" name="phone" pattern = "((09|03|07|08|05)+([0-9]{8})\b)" required>   
