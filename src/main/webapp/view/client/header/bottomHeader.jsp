				...
				<div class="aa-header-bottom-area">
					...
					<div class="aa-logo">
						...
						<a href="${pageContext.request.contextPath}/"><img
							src="${url}/images/logoHTC.jpg" alt="logo img" width="75%"></a>
					</div>
					<!-- / logo  -->
					<!-- Shipping service -->
					<div class="aa-shipping-box">
						<a class="aa-shipping-boxsmall"> <!-- <span class="aa-shipping-boxsmall-icon fas fa-shipping-fast"></span> -->
							<span class="aa-shipping-box-text">
								<div class="aa-shipping-title">Miễn phí vận chuyển</div>
								<div class="">Khu vực TP HCM</div>
						</span>

						</a> <a class="aa-shipping-boxsmall"> <!-- span class="aa-shipping-boxsmall-icon fas fa-phone"></span> -->
							<span class="aa-shipping-box-text">
								<div class="aa-shipping-title">Hỗ trợ: 085.4926.311</div>
								<div class="">Tư vấn tự làm đồ thủ công</div>
						</span>

						</a> <a class="aa-shipping-boxsmall"> <!-- <span class="aa-shipping-boxsmall-icon fas fa-shipping-fast"></span> -->
							<span class="aa-shipping-box-text">
